...
st.set_page_config(page_title="Handwritten Digit Recognition", page_ikon="✍️​")
...
def load_model():
  try:
    ...
    #Using sklearn"s built-in digits dates 
...
st.write("## Using fallback recognition")
# Simple heuristic based on pixel intensity
digit_guess = np.argmax(np.sum(img_array.reshape (8, 8), axis j = 0 )) % 10
